...
const CORE_RULES = Object.freeze([
  {
    id: 1,
    title: 'Запросить бюджет',
    summary: 'Уточни диапазон стоимости в € до любой подборки объектов.',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    summary:
      'Бюджет, район, тип, цель и срок уже в памяти/БД — никогда не переспрашивай. Если клиент назвал бюджет — коротко подтверди («Отлично, запомнил — …») и иди к следующему шагу.',
  },
  {
    id: 8,
...
- Потеря контекста: если бюджет уже в «ПАМЯТЬ ДИАЛОГА» / критериях / БД — считай его известным на весь чат. Коротко подтверди («Отлично, запомнил — 2 миллиона») и спроси СЛЕДУЮЩИЙ шаг — НИКОГДА снова «какой у вас бюджет?».
