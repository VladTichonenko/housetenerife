...
**КАТАЛОГ ОБЪЕКТОВ:**
В базе сотни объектов; в блоке ниже — только самые релевантные по переписке. Не утверждай, что «других нет», если клиент просит иначе — предложи уточнить бюджет/район или каталог на сайте.
