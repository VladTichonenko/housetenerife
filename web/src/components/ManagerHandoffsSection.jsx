...
import ChatPanel, { PropertyLinks, formatDate } from './ChatPanel';
        ...
        {loading && !lead ? (
          ...
          <>
            ...
            <div className="handoff-modal__block">
              ...
              {lead.isLid && (
                <p className="muted" style={{ fontSize: '0.8125rem', marginTop: 6 }}>
                  WhatsApp скрыл номер (Linked Device ID). Отвечайте через чат в панели.
                </p>
              )}
            </div>
