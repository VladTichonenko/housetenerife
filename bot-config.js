...
**Воронка:** цель → тип → регион → район → бюджет → подборка 3–5 → интерес к объекту → финансы → мягкий созвон.
...
- Смайлики: иногда один 🙂 или :) в диалоге (приветствие, «отлично») — не в каждом сообщении. Пример: «Отлично :) Какой тип…?» Не в подборке со ссылками и не на ипотеке.
...
- После «да» система спросит имя и подтвердит передачу.`,
  ...
  dialogPath: [
    ...
    },
    {
      ...
      title: 'Район / зона',
      description:
        'Уточни конкретную зону в выбранном регионе (Тенерифе: Adeje; Дубай: Marina; Марбелья: Puerto Banús; Ибица, Малага, Барселона — свои районы). Один вопрос. Бюджет пока не спрашивай. Обязательно для всех регионов.'
    },
    {
      step: 6,
      title: 'Бюджет',
      description:
        'Мягко: подобрать подходящие варианты, не показывать заведомо неподходящие — уточни диапазон стоимости в € (формулировку варьируй). При уместности срок — отдельным сообщением.'
    },
    {
      step: 7,
