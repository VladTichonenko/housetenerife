...
const stageInstructions = {
  ...
  SHOW_LISTINGS: `ОБЯЗАТЕЛЬНО дай подборку 3–5 объектов прямо сейчас (не обещай «пришлю позже» и не ходи кругами с уточнениями): тип ${'{propertyTypeLabel}'}, регион ${'{regionLabel}'}, район ${'{microAreaLabel}'}. Только из блока каталога. Весь текст ответа — на языке диалога клиента. Формат:
• *Название* — €цена
...
Закрой: «Какой вариант ближе — или скорректируем бюджет/район?» Не предлагай дешевле бюджета без запроса.`,
  ...
  REFINE: `Ответь по последней реплике. Если нужна новая подборка — 3–5 объектов (название, цена, одна фраза-выгода без ярлыка «Почему вам», ссылка). Если клиент сомневается — предложи альтернативу (другой район, чуть выше бюджета). Один вопрос в конце.`,
